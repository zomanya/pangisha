...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- Header -->
    <header style="background-image:url('pangisha.jpg');" class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Room Rental Searching!</div>
                        ...
                        <div class="card-block">';
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              echo '<p><b>Company Name: </b>'.$value['fullname'].'</p>';
                              echo '<p><b>Numba ya Simu: </b>'.$value['mobile'].'</p>';
                              echo '<p><b>Namba ya Simu: </b>'.$value['alternat_mobile'].'</p>';
                              echo '<p><b>Email: </b>'.$value['email'].'</p>';
                              echo '<p><b>Nchi: </b>'.$value['country'].'</p><p><b>Mkoa: </b>'.$value['state'].'</p><p><b> Mtaa: </b>'.$value['city'].'</p>';
                              if ($value['image'] !== 'uploads/') {
                                # code...
                                echo '<img src="app/'.$value['image'].'" width="200">';
                              }
                          ...
                          echo '</div>
                            ...
                            <h4 class="text-center">Room Details</h4>';
                              ...
                              echo '<p><b>Aina ya Chumba: </b>'.$value['plot_number'].'</p>';

                              if(isset($value['sale'])){
                                echo '<p><b>Huduma ya Maji: </b>'.$value['sale'].'</p>';
                              } 
                              ...
                              echo '<p><b>Floor: </b>'.$value['rooms'].'</p>';
                              echo '<p><b>Kodi kwa Mwezi: </b>'.$value['address'].'</p><p><b> Unalipa Miezi: </b>'.$value['landmark'].'</p>';
                          echo '</div>
                            <div class="col-3">
                            <h4>Other Details</h4>';
                            echo '<p><b>Fensi: </b>'.$value['accommodation'].'</p>';
                            echo '<p><b>Parking: </b>'.$value['description'].'</p>';
                              if($value['vacant'] == 0){ 
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; Chuga 2024</span>
          </div>
          <div class="col-md-4">
